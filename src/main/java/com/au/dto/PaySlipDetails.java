...
public class PaySlipDetails {
	...
	private String school_org_name;
	private String school_short_name;
	private Float ctc;
	private Float lic;
	private Double examRemuneration;
	private List<InvPayPaySlipDTO> invPayPaySlipDTOs;

	public PaySlipDetails(String empCode, String employeeName, String dateOfJoining, String departmentName,
			...
			String schoolName,Float pTax,String uan_no,String transport_deassign_month,String pf_no,String pan_no,
			String school_org_name,String school_short_name, Float ctc,Float lic,Double examRemuneration) {
		...
		this.pf_no = pf_no;
		this.pan_no = pan_no;
		this.school_org_name=school_org_name;
		this.school_short_name=school_short_name;
		this.ctc=ctc;
		this.lic=lic;
		this.examRemuneration=examRemuneration;
	...
	public PaySlipDetails(String empCode, String employeeName, String dateOfJoining, String departmentName,
			...
			Float epfDifference, Float pensionFund, Float esiEarnings, Float esiContributionEmployee, String passportNo,
			Double er, Float tax, String pinfl, Integer month, Integer year, Float advance, String remarks,
			String schoolName,Float pTax,String uan_no,String transport_deassign_month,String pf_no,String pan_no,String school_org_name,String school_short_name,Float ctc, Float lic,List<InvPayPaySlipDTO> invPayPaySlipDTOs) {
