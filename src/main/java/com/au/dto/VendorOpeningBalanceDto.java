...
public class VendorOpeningBalanceDto {

	
	
	private Integer ob_id;
	private HashMap<Integer, Double> school_id;
	...
	public VendorOpeningBalanceDto() {
		super();
	}
	...
	public HashMap<Integer, Double> getSchool_id() {
		return school_id;
	}

	public void setSchool_id(HashMap<Integer, Double> school_id) {
