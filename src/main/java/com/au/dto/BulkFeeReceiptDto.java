...
public class BulkFeeReceiptDto {
	
	private Integer bulk_fee_receipt_id;
	private Double amount_in_som;
	private Integer student_id;
	private HashMap<Integer, Double> voucher_head_new_id;
	...
	private TallyReceipt tr;
	private FeeReceipt fr;
	...
	public TallyReceipt getTr() {
		return tr;
	}


	public void setTr(TallyReceipt tr) {
		this.tr = tr;
	}


	public FeeReceipt getFr() {
		return fr;
	}


	public void setFr(FeeReceipt fr) {
		this.fr = fr;
	}


	public BankImportTransaction getBit() {
		return bit;
	}


	public void setBit(BankImportTransaction bit) {
		this.bit = bit;
	}
	...
	public HashMap<Integer, Double> getVoucher_head_new_id() {
		return voucher_head_new_id;
	}


	public void setVoucher_head_new_id(HashMap<Integer, Double> voucher_head_new_id) {
