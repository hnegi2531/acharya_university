...
@Entity
@Table(name = "fee_template_sub_amount")
public class FeeTemplateSubAmount {
	...
	public void setVoucher_head_id(Integer voucher_head_new_id) {
	...
	public String toString() {
		return "FeeTemplateSubAmount [fee_sub_amt_id=" + fee_sub_amt_id + ", fee_template_id=" + fee_template_id
				+ ", voucher_head_new_id=" + voucher_head_new_id + ", board_unique_id=" + board_unique_id
				+ ", alias_id=" + alias_id + ", year1_amt=" + year1_amt + ", year2_amt=" + year2_amt + ", year3_amt="
				+ year3_amt + ", year4_amt=" + year4_amt + ", year5_amt=" + year5_amt + ", year6_amt=" + year6_amt
				+ ", year7_amt=" + year7_amt + ", year8_amt=" + year8_amt + ", year9_amt=" + year9_amt + ", year10_amt="
				+ year10_amt + ", year11_amt=" + year11_amt + ", year12_amt=" + year12_amt + ", total_amt=" + total_amt
				+ ", created_by=" + created_by + ", modified_by=" + modified_by + ", created_date=" + created_date
				+ ", modified_date=" + modified_date + ", receive_for_all_year=" + receive_for_all_year + ", active="
				+ active + ", remarks=" + remarks + ", created_username=" + created_username + ", modified_username="
				+ modified_username + "]";
	}
