...
public class Student_Details implements Serializable {
	...
	/*
	 * @Column(length = 20) private String current_adress2;
	 */
	@Column(length = 200)
	...
	/*
	 * In course_approver_status integer 1 and 2 is inserting in old student row date,meaning of integer
	 * value is :-
	 * 2 = Initiated,
	 * 1 = approved
	 * 
	 * While creation Of new student row at the time of initiation of change of course process,it's inserting by default int value,it
	 * is 0 and After it will become null after approved  
	 * 
	 */
