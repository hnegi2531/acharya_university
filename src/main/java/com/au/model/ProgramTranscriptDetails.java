...
@Entity
@Table(name = "program_transcrption_details")
...
//	private String transcript_short_name;
	...
	public String toString() {
		return "ProgramTranscriptDetails [transcript_id=" + transcript_id + ", trans_id=" + trans_id + ", program_id="
				+ program_id + ", created_by=" + created_by + ", modified_by=" + modified_by + ", created_date="
				+ created_date + ", modified_date=" + modified_date + ", active=" + active + ", foriegn_status="
				+ foriegn_status + ", created_username=" + created_username + ", modified_username=" + modified_username
				+ "]";
	}
