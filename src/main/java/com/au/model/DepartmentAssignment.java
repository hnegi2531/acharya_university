...
@Entity
@Table(name = "dept_assign")
public class DepartmentAssignment {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer dept_assign_id;
	...
	public Integer getDept_assign_id() {
		return dept_assign_id;
	}

	public void setDept_assign_id(Integer dept_assign_id) {
		this.dept_assign_id = dept_assign_id;
	}
